...
export default () => {
  ...
  if (program.length == 0) return <Loading></Loading>
    ...
    return <div className="contact">
        ...
        <article className="contact_body ml-5 mt-5">
          <div className="mt-1"><Globe></Globe> Do you  have internet connection? <a>Call free</a></div>
...
const Phone = () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
