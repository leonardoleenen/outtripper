...
const Action = (item: any) => {
  return <div className="border-solid border-t-2 p-3">{item.title} <ArrowDown></ArrowDown></div>
}
...
export default () => {
  ...
  if (manage.length == 0) return <Loading></Loading>
...
<path d="M9.2625 10.3688L15 16.0938L20.7375 10.3688L22.5 12.1313L15 19.6313L7.5 12.1313L9.2625 10.3688Z" fill="black" fill-opacity="0.54"/>
</svg>
)