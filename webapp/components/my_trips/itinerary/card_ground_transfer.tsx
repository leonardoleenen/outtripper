...
export default (props: Props) => {
  return <div className="ground_transfer_main_container m-2 rounded-b-lg">
          ...
          <article className="ground_transfer_data bg-gray-100 rounded-b-lg">
            <div className="mt-5 ml-3">
              <img src={props.transfer_data.driver.photo} />
              <p className="driver_name">{props.transfer_data.driver.firstname} {props.transfer_data.driver.lastname}</p>
            </div>
            <div className="article-column">
              <p>From: { props.transfer_data.from }</p>
              <p>To: { props.transfer_data.to }</p>
              <p className="pickup_time">Pickup Time: {moment(props.transfer_data.pickup_time).format('h:mm a')}</p>
            </div>
          </article>
          <article className="ground_transfer_contact pt-2">
            ...
            <div className="ml-10">
              <PhoneLink></PhoneLink>
              call to {props.transfer_data.driver.firstname}
            </div>
          </article>
          <style>
              {
...
const AirportShuttle = () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="icon/places/airport_shuttle_24px">
<path id="icon/places/airport_shuttle_24px_2" fill-rule="evenodd" clip-rule="evenodd" d="M17 5H3C1.9 5 1 5.89 1 7V16H3C3 17.66 4.34 19 6 19C7.66 19 9 17.66 9 16H15C15 17.66 16.34 19 18 19C19.66 19 21 17.66 21 16H23V11L17 5ZM15 7H16L19 10H15V7ZM13 7H9V10H13V7ZM3 7H7V10H3V7ZM4.75 16C4.75 16.69 5.31 17.25 6 17.25C6.69 17.25 7.25 16.69 7.25 16C7.25 15.31 6.69 14.75 6 14.75C5.31 14.75 4.75 15.31 4.75 16ZM18 17.25C17.31 17.25 16.75 16.69 16.75 16C16.75 15.31 17.31 14.75 18 14.75C18.69 14.75 19.25 15.31 19.25 16C19.25 16.69 18.69 17.25 18 17.25ZM20.22 14H21V12H3V14H3.78C4.33 13.39 5.11 13 6 13C6.89 13 7.67 13.39 8.22 14H15.78C16.33 13.39 17.12 13 18 13C18.88 13 19.67 13.39 20.22 14Z" fill="#718096"/>
</g>
</svg>
)
